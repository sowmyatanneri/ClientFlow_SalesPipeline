...
#  for (( i=1 ; i <= $totalruns; i++ ))
  ...
  do
    ...
    json={"\"filename\"":"\"10000\u0020Sales\u0020Records.csv\",\"bucketname\"":\"test.bucket.562.firsttest\",\"seqID\"":0,\"threadId\"":$threadid}
    ...
    ####################################
    output=`aws lambda invoke --invocation-type RequestResponse --function-name loadCSV --region us-east-2 --payload $json /dev/stdout | head -n 1 | head -c -2 ; echo`
